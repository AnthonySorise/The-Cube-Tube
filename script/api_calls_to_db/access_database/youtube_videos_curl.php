...
$ch = curl_init("https://www.googleapis.com/youtube/v3/search?type=video/?channelId={$youtube_channel_id}&part=snippet&order=date&maxResults=50&pageToken={pageToken}&key={$DEVELOPER_KEY}");
// $pageToken
