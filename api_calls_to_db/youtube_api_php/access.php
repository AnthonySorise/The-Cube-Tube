...
//main youtube api code
if (!file_exists($file = __DIR__ . '../youtube_api_php/vendor/autoload.php')) {
...
switch($_POST['action']){
    case 'read_channels_from_youtube':
        include('./api_calls_to_db/youtube_api_php/read_channels_from_youtube.php');
        break;
    case 'read_videos_from_youtube':
        include('./api_calls_to_db/youtube_api_php/read_videos_from_youtube.php');
        break;
    default:
